...
- The "Follow the flow" button (bottom left) opens a collapsible bottom sheet built from that data: a bar with "Step n of 13", then the phase label, title, what happens, the handoff to the next part, a clickable progress track grouped by phase, and Back/Next. Arrow keys work; Escape leaves.
